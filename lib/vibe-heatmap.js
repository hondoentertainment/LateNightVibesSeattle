...
(function (exports) {
  ...
  function _getVenueMap() {
    var map = {};
    var data = null;
    // Try browser-loaded venue data
    if (typeof window !== "undefined" && window._lnvData && Array.isArray(window._lnvData)) {
      data = window._lnvData;
    }
    // Fallback: check globalThis (for Node/test environments)
    if (!data && typeof globalThis !== "undefined" && globalThis._lnvData && Array.isArray(globalThis._lnvData)) {
      data = globalThis._lnvData;
    }
    if (data) {
